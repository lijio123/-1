<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    import="java.util.*,java.time.*,com.lijio.domain.*"
    %>
...
out.print("上课时间："+clocking.getWorkTime()+"<br/>");
out.print("午休时间："+clocking.getNoonBreakTime()+"<br/>");
out.print("下午上课时间："+clocking.getAfternoonWorkTime()+"<br/>");
out.print("下课时间："+clocking.getOffWorkTime()+"<br/>");
%>
